          ...
          <div className="relative mt-20 reveal reveal-delay-2">
            ...
            <div className="relative overflow-hidden rounded-3xl glass-strong p-2">
              <div className="relative aspect-[16/9] w-full overflow-hidden rounded-2xl"
                ...
                <img src={variants[3].image} alt={variants[3].name} className="absolute inset-0 h-full w-full object-contain p-4 sm:p-6" />
              </div>
              <div className="flex flex-wrap items-center justify-between gap-3 p-4 sm:p-6">
                <div className="min-w-0">
                  ...
                  <div className="mt-1 font-display text-base sm:text-xl md:text-2xl font-bold break-words">{variants[3].model} · {variants[3].name}</div>
                </div>
